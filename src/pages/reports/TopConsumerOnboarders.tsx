...
import { useConsumerOnboarderRewardsStore } from "../../stores/consumerOnboarderRewardsStore";
...
const TopConsumerOnboardersReport = () => {
  const REPORT_KEY = "top-consumer-onboarders";
  const {
    viewState,
    data,
    filters,
    ...
    fetchForDays,
    totalAmount,
  } = useConsumerOnboarderRewardsStore();
  ...
  return (
    <CommonLayout title="Top Consumer On-boarders">
      <ReportChart
        title="Consumer On-boarders"
        data={chartData}
        viewState={viewState}
        chartType={chartType}
        filters={filters}
...
export default TopConsumerOnboardersReport;
